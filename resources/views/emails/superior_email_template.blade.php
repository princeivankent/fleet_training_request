						...
						<td align="center">
								...
								<tr>
									<td align="center" style="color: #00A65A; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
										<div style="line-height: 26px;">
											<a href="<?php echo config('app.url'). '/admin'; ?>" style="color: #ffffff; text-decoration: none;">Deny</a>
										</div>
									</td>
								</tr>
							...
							<table border="0" width="150" cellpadding="0" cellspacing="0" bgcolor="00A65A" style="float: left">
								...
								<tr>
									<td align="center" style="color: #00A65A; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
										<div style="line-height: 26px;">
											<a href="<?php echo config('app.url'). '/admin'; ?>" style="color: #ffffff; text-decoration: none;">Approve</a>
										</div>
									</td>
								</tr>
